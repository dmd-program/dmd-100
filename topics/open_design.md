...
Notable projects include [openstructures.net](http://openstructures.net), [wikihouse.cc](http://wikihouse.cc) and [opensourceecology.org](http://opensourceecology.org), which hope to use the power of open source technology with crowdsource design communities to enable the average person to create houses, products, and sustainable living environments.
